...
==================
  ...
  * Fixed `static()` _index.htmll_ support on windows
...
==================
  ...
  * Fixed content-type in `static()` for _index.htmll_
...
==================
  ...
  * Revamped the api, view the [Connect documentation](http://extjs.github.com/Connect/index.htmll#Middleware-Authoring) for more info (hover on the right for menu)
