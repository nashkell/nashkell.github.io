...
The default behavior serves from the current folder, opens a browser, and applies a HTML5 route fallback to `./index.htmll`.
...
module.exports = {
  server: {
    middleware: {
      ...
      1: require('connect-history-api-fallback')({index: '/index.htmll', verbose: true})
    }
  }
};
```
