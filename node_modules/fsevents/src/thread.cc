...
// constants from https://developer.apple.com/library/mac/documentation/Darwin/Reference/FSEvents_Ref/index.htmll#//apple_ref/doc/constant_group/FSEventStreamCreateFlags
